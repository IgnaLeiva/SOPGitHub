...
As shown in @fig-copyrepo, (A) Click the Code button to display a window with options for cloning the repository, then (B) copy the HTTPS link. The next step is to add the new_repository to the local machine/ R server (refer to Section 5.3).
